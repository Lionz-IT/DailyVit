      ...
      if (!isAuthenticated) {
        if (isMounted) {
          setSummary({
            ...
            total_calories: 0,
            avg_heart_rate: 0,
            smart_insight: '👋 Halo! Silakan login untuk mulai melacak aktivitas, melihat metrik kesehatan yang akurat, dan mendapatkan wawasan pintar harian Anda.',
