...
export const Settings: React.FC = () => {
  ...
  const handleDisconnectHuawei = async () => {
    if (!window.confirm('Are you sure you want to disconnect from Huawei Health?')) return;
    ...
    <div className="p-4 lg:p-8 space-y-6 lg:space-y-8 w-full min-h-full">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage your app preferences and connections</p>
        </div>
      </div>
