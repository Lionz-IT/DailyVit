...
export const SmartInsightPanel: React.FC<SmartInsightPanelProps> = ({ insight }) => {
  return (
    <div className="bg-gradient-to-r from-indigo-900 to-primary rounded-2xl p-5 shadow-sm my-6 transition-colors duration-200">
      <div className="flex items-center justify-between gap-4">
        ...
        <button className="shrink-0 text-xs font-semibold text-indigo-900 bg-white hover:bg-white/90 px-4 py-2 rounded-lg transition-colors whitespace-nowrap">
